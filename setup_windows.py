...
if sys.platform.startswith("win32"):
  install_requires.extend(windows_requires)
...
setup(
  ...
  description="Distributed inference framework optimized for Windows",
  author="Exo Labs",
  long_description="Run your own inference cluster on Windows with everyday devices",
)
